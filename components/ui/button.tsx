...
export function Button({
  ...
  return (
    <button
      className={[
        "inline-flex min-h-11 items-center justify-center gap-2 rounded-[var(--radius-md)] px-5 py-3 text-sm font-bold transition-[background-color,opacity,transform] duration-150 ease-out active:translate-y-px disabled:bg-inset disabled:text-tertiary",
