...
const coachApplySpec = "tests/auth-ui-e2e/coach-apply.spec.ts"

async function main() {
  const [outputPath = path.join(".omo/evidence", "coach-apply-focused-summary.json")] =
